<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Template2.Master" CodeBehind="Result1.aspx.vb" Inherits="CIS4290_Image_Classification_website.Result1" %>
                                                                                        ...
                                                                                        <div class="elementor-column-wrap  elementor-element-populated">
                                                                                            <div class="elementor-widget-wrap">
                                                                                                <div class="elementor-element elementor-element-bd83677 elementor-widget elementor-widget-text-editor" data-id="bd83677" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                                    <div class="elementor-widget-container">
                                                                                                        <div class="elementor-text-editor elementor-clearfix">
                                                                                                            <h4>To our suprise, the image set was so large that it would already burn through the virtual ram from google Collabs.</h4>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="elementor-element elementor-element-478cf4b elementor-widget elementor-widget-text-editor" data-id="478cf4b" data-element_type="widget" data-widget_type="text-editor.default">
                                                                                                    <div class="elementor-widget-container">
                                                                                                        <div class="elementor-text-editor elementor-clearfix">
                                                                                                            <p>
                                                                                                                That didn't stop us as we found other tools such as Pycharm that allowed us to use our computers 
                                                                                                            </p>
                                                                                                            <p>
                                                                                                                We discovered a new problem since we finally were able to run the model. We each took different classes within the image set to see if there were anything wrong with them. Long story short, many photos in many of the classes were not meant to be there.
                                                                                                            </p>
                                                                                                            <p>
                                                                                                                As such, since cleaning out the bad photos, we get to the result we see today.
                                                                                                            </p>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="elementor-element elementor-element-80412c6 elementor-widget elementor-widget-image" data-id="80412c6" data-element_type="widget" data-widget_type="image.default">
                                                                                                    <div class="elementor-widget-container">
                                                                                                        <div class="elementor-image">
                                                                                                            <img width="780" height="657" src="images/img1_ValidChart.jpg" class="attachment-large size-large" >
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
